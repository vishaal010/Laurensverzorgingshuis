    ...
    <div class="container">
        ...
        <div class="row">
            <form action="include/delete_appointment.inc.php" method="post">
                ...
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Gebruikersnaam</label>
                    <input class="form-control" disabled value="<?php echo $row['username']; ?>" name="username" type="text">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Email</label>
                    <input class="form-control" disabled value="<?php echo $row['email']; ?>" name="email" type="text">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlSelect1">Telefoonnummer</label>
                    <input class="form-control" disabled value="<?php echo $row['tel']; ?>" name="tel" type="text">
                </div>
